...
variable "github_connector_name_2" {
...
# as tenant 1, onboarded into the tenant-2 Wiz provider.
resource "wiz-v2_generic_connector" "github_t2" {
  provider = wiz-v2.tenant2

  name = var.github_connector_name_2
  type = "github"
